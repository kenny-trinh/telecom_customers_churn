...
```{r EDA-Visualizations, echo=FALSE, results='asis', warning=FALSE}
...
```{r GLM-Binomial-GAM-DataPreparation, echo=FALSE, results='show', message=FALSE, warning=FALSE}
...
```{r GLM-Binomial-GAM-Visualizations, echo=FALSE, results='asis'}
...
```{r GLM-Binomial-GAM-Visualizations2, echo=FALSE, results='asis'}
...
```{r GLM-Binomial-GAM-Visualizations3, echo=FALSE, results='asis'}
...
```{r GLM-Binomial-GAM-Visualizations4, echo=FALSE, results='asis'}
...
```{r GLM, echo=FALSE, results='show', message=FALSE, warning=FALSE}
...
```{r GLM-Overfitting, echo=FALSE, results='show', message=FALSE, warning=FALSE}
library(pROC)
...
```{r GLM-CrossValidation, echo=FALSE, results='show', message=FALSE, warning=FALSE}
library(caret)
...
```{r GAM-WithNonLinearPatterns, echo=FALSE, results='show', message=FALSE, warning=FALSE}
library(mgcv)
...
```{r ROC-Comparison, echo=FALSE, results='asis'}
...
```{r Anova-Comparison, echo=FALSE, results='show', message=FALSE, warning=FALSE}
anova(glm_model_interaction, gam_smoothing_spline, test = "Chisq")
```

GAM explains more variance than GLM.

```{r AIC-Comparison, echo=FALSE, results='show', message=FALSE, warning=FALSE}
...
| **Configuration** | **Size** | **Decay** | **Accuracy** | **Sensitivity** | **Specificity** | **Balanced Accuracy** | **Kappa** |
|--------|--------|--------|--------|--------|--------|--------|--------|
