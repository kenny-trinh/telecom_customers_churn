...
| **Predictor** | **Effect on Log(Monthly Charges)** | **Interpretation** |
| --- | --- | --- |
| **Tenure** | `+0.00064` per month | Longer tenure leads to slightly higher monthly charges. |
| **Internet Service (Fiber Optic)** | `+0.347` (**+41.5%**) | Customers with fiber optic internet pay **41.5% more** than DSL users. |
| **Internet Service (No Service)** | `-0.863` (**-57.8%**) | Customers with **no internet service** pay **57.8% less** than DSL users. |
| **Contract (Two Years)** | `+0.00882` (**+9.2%**) | Two-year contracts **increase monthly charges by ~9.2%**. |
| **Additional Services (Streaming, Security, Backup, Tech Support, Device Protection, Phone Service)** | **Increase charges by 6% - 55%** | Customers with **one or more additional services pay significantly more**, with Phone Service having the biggest impact (~55%). |
