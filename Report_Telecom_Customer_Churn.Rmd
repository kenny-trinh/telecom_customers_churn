...
```{r EDA-Visualizations, echo=FALSE, results='show', warning=FALSE, cache=TRUE}
...
**Correlation Analysis**
  - TotalCharges and Tenure have a very high correlation (r ≈ 0.98), meaning one could be removed in some           models   to avoid multicollinearity.
