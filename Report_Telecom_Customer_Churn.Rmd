...
```{r NN-TrainNN, echo=TRUE, results='show', message=FALSE, warning=FALSE, cache=TRUE}
...
```{r NN-ExperimentationWithDifferentArchitectures, echo=FALSE, results='asis', message=FALSE, warning=FALSE, cache=FALSE}
library(RSNNS)
library(ggplot2)
