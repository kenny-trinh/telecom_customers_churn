...
```{r EDA-Histograms-LogTransform, echo=FALSE, results='show', fig.width = 9, fig.height = 7, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r EDA-Boxplots, echo=FALSE, results='show', fig.width = 8, fig.height = 8, warning=FALSE, cache=TRUE}
...
```{r EDA-CorrelationMatrix, echo=FALSE, results='show', fig.width = 4.5, fig.height = 4.5, warning=FALSE, cache=TRUE}
...
```{r Poisson-Visualizations, echo=FALSE, fig.width = 9, fig.height = 5, results='show', cache=TRUE}
...
```{r Quasi-Poisson-Model, echo=FALSE, results='hide', message=FALSE, warning=FALSE, cache=TRUE}
...
```{r GLM-Binomial-GAM-DataPreparation, echo=FALSE, results='hide', message=FALSE, warning=FALSE, cache=TRUE}
...
```{r GLM-Binomial-GAM-Visualizations2, echo=FALSE, fig.width = 9, fig.height = 5, results='asis', cache=TRUE}
...
```{r GLM-Binomial-GAM-Visualizations3, echo=FALSE, fig.width = 9, fig.height = 5, results='asis', cache=TRUE}
...
```{r GLM-Binomial-GAM-Visualizations4, echo=FALSE, fig.width = 9, fig.height = 5, results='asis', cache=TRUE}
...
```{r GLM, echo=FALSE, results='hide', message=FALSE, warning=FALSE, cache=TRUE}
...
```{r GAM-WithNonLinearPatterns, echo=FALSE, results='hide', message=FALSE, warning=FALSE, cache=TRUE}
library(mgcv)
...
: Interpretation of GAM Coefficients
...
- **Total Charges (s(TotalCharges_centered))**: A significant non-linear relationship suggests that higher total charges reduce churn, though the effect is not constant across values.
...
- **Smooth Terms for Non-linear Effects**:
  - **Tenure** and **TotalCharges_centered** have highly significant non-linear effects (p < 0.001), as indicated by their effective degrees of freedom (edf).
...
```{r ROC-Comparison, echo=FALSE, fig.width = 6, fig.height = 3, results='show', cache=TRUE}
...
```{r NN-EvaluateModel, echo=FALSE, fig.width = 6, fig.height = 3, results='show', message=FALSE, warning=FALSE, cache=TRUE}
library(caret)
library(pROC)
...
```{r NN-ThresholdAdjustment, echo=FALSE, fig.width = 6, fig.height = 3, results='show', message=FALSE, warning=FALSE, cache=TRUE}
library(pROC)
...
```{r NN-ResamplingWithWeightRatio, echo=FALSE, fig.width = 6, fig.height = 3, results='show', message=FALSE, warning=FALSE, cache=TRUE}
library(nnet)
library(caret)
library(pROC)
...
## GitHub Repository
https://github.com/kenny-trinh/telecom_customers_churn
...
```{r, echo=FALSE, results='show', message=FALSE, warning=FALSE, cache=TRUE}
# Ensure 'InternetService' is a factor
data$InternetService <- as.factor(data$InternetService)
